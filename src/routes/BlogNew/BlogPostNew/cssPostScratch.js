`<intro>
It’s time to delve into the most visually-stimulating side of web development: CSS. CSS stands for <a>https://developer.mozilla.org/en-US/docs/Web/CSS, Cascading Style Sheets</a> – emphasis on STYLE – and it’s where we write the instructions for an internet browser to beautify a webpage. Hold on tight – color, texture and pizzazz incoming!
</intro>
...
<steps>
   ...
   {"stepTitle" : "STEP 1: OPEN YOUR PROJECT FOLDER IN YOUR IDE", "stepContent":
      "
      <p>
If you followed along with the <link>../blog/set-up-ide, Set up an IDE</link>article, you should have ended up with a folder containing one HTML file.. Open up that folder inside your IDE:
      </p>
...
"
<p>
Copy and paste the <a> https://gist.github.com/lindsayjohnston/f3b21aa79fd72b9a7b81f5b3881b6ec9, boilerplate HTML</a>  from the <link>..blog/create-your-first-webpage, Create Your First Webpage Article</link>.
</p>
<p>
...
<img>Link added, https://portfolio-2023.s3.us-east-2.amazonaws.com/BlogPostMedia/AddCssToSimpleWebsite/added-link.png</img>

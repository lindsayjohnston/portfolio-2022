        ...
        <div className="music-page page-content">
            <div className="content-area">
                ...
                <section className="section-even flex-column">
                    ...
                    <a href="https://open.spotify.com/album/2R7DUK2sMjv9686ranhsmM" className="secondary-link-style">Listen on Spotify</a>
                </section>
                <section className="section-odd flex-column">
                    ...
                    <a href="https://open.spotify.com/album/5osR7zeT0g7Nqc8SK0R8i2?si=OCQmAb34RAWviB0Qo4O3XA" className="secondary-link-style">Listen on Spotify</a>
                </section>
                <section className="section-even flex-column">
                    ...
                    <a href="https://open.spotify.com/album/4TpBORzcX6IAgEnn1yJzUJ" className="secondary-link-style">Listen on Spotify</a>
                </section>
            </div>
        </div>
    )

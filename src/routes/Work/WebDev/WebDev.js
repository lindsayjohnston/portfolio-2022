...
const WebDev = () => {
    ...
    const handleBlogEditorButtonClick = (e) => {
        e.preventDefault()
        alert("The blog editor requires credentials to access. Please contact lindsaykjohnston@outlook.com for a demo!")
    }
        ...
        <div className="web-dev-page page-content">
            <div className="content-area">
                ...
                <section className="section-even flex-column">
                    ...
                    <button onClick={handleBlogEditorButtonClick}
